        ...
        success: function (response) {
            if (response['result'] === 'success') {
                ...
                for (let i = 0; i < posts.length; i++) {
                    ...
                    let class_heart = post['heart_by-me'] ? 'fa-heart' : 'fa-heart-o';
                    let class_star = post['star_by-me'] ? 'fa-star' : 'fa-star-o';
                    let class_thumbsup = post['thumbsup_by-me'] ? 'fa-thumbs-up' : 'fa-thumbs-o-up';
                    let html_temp = `
